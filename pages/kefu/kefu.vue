<template>
	<view class="contain">
		...
		<view class="card">
			<view class="card1">
				<image class="wechatimg" src="/static/images/online.png" />
			</view>
		...
		<!-- 微信联系 -->
		<view class="card" @tap="copy" :data-copy="weixin" data-name="微信">
			<view class="card1">
				<image class="wechatimg" src="/static/images/weixin.png" />
			</view>
			<view class="borderbox">
				<view class="border"></view>
			</view>
		...
		<!-- QQ联系 -->
		<view class="card" @tap="copy" :data-copy="qq" data-name="QQ">
			<view class="card1">
				<image class="wechatimg" src="/static/images/qq.png" />
			</view>
			<view class="borderbox">
				<view class="border"></view>
			</view>
		...
		<!-- 电话联系 -->
		<view v-if="phone" class="card" @tap="phoneFun1" :data-phone="phone">
			<view class="card1">
				<image class="wechatimg" src="/static/images/phone.png" />
			</view>
			<view class="borderbox">
				<view class="border"></view>
			</view>
