<template>
	<view style="height: 100%">
		...
		<view class="contain" @tap="preview" :data-link="shareImage">
			<image mode="widthFix" class="shareImage" :src="shareImage"></image>
		</view>

		<view class="bottom" @tap="eventSave">
			<view>保存到手机</view>
		</view>
		<Dialog confirm-button - color="#fbbd08" id="van-dialog" />

		<Dialog title="授权失败" message="您之前误点了拒绝授权，请允许保存此图片至您的相册" :show="show" confirm-button-color="#fbbd08" confirm-button-open-type="openSetting" @opensetting="getSetting"></Dialog>
	</view>
</template>
