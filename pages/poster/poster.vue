<template>
	<view style="height: 100%">
		...
		<Dialog title="授权失败" message="您之前误点了拒绝授权，请允许保存此图片至您的相册" :show="show" confirm-button-color="#fbbd08"
			confirm-button-open-type="openSetting" @opensetting="getSetting"></Dialog>
	</view>
</template>
