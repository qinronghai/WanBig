<template>
	<view id="page">
		<view class="top_contain">
			<swiper indicator-color="#e9e9e9" indicator-active-color="#ffc300" circular indicator-dots interval="3000"
				:duration="800">
		...
		<view class="publish_wrap" v-if="first_title">
			...
			<view class="palceInput_box" v-if="publishinfo.deliveryid == 1">
				<input @input="placeInput" placeholder="卖家可以帮送，请填写您的收货地址" maxlength="20" />
			</view>
		...
		<view class="tabbar">
			...
			<view class="buy_box">
				<view class="buy shadow" @tap="buy">{{ publishinfo.status == 0 ? "立即预定" : "刚刚被抢光了" }}</view>
			</view>
		</view>
	</view>
</template>
