	...
	<view class="container">
      ...
      style="height: 620rpx" /> -->
		...
		<view class="bottom_box">
			<view class="bottom_card" @tap="go" data-go="/pages/use-know/use-know">
				<view class="bottom_1">
			...
			<view class="bottom_card" @tap="go" data-go="/pages/about/about" data-status="2">
				<view class="bottom_1">
...
<style lang="scss" scoped>
	...
	.container {
		...
		.wrap-nav {
			...
			// width: 100vw;
			height: 140rpx;
			padding: 10rpx 42rpx 20rpx 42rpx;
