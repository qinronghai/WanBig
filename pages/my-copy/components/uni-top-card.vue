  ...
  <div class="wrap">
    ...
    <div class="top-person-info">
      <div
        ...
        v-on:click="login">
        <image
          :src="showAvatar ? avatarUrl : defaultAvatar"
          mode="aspectFill"
      ...
      <van-popup
        ...
        <div class="login">
          ...
          <div class="btn-login">
            <button
              class="btn"
              v-on:click="clickOneLogin">
              微信一键登录
            </button>
          </div>
          <div
            class="no-login"
            v-on:click="clickNoLogin">
            暂不登录
          </div>
      ...
      <div class="right">
        <div
          ...
          v-if="userInfo.vip">
          <image
            class="label__icon vip"
            src="../../../static/goods-detail/vip.svg"
            mode="" />
          <span class="vip__txt">vip</span>
        </div>
        <div
          class="label auditor"
          v-if="userInfo.isAuditor">
          <image
            class="label__icon"
            src="../../../static/goods-detail/auditor.svg"
            mode="" />
          <span class="auditor__txt">审核员</span>
        </div>
        <div
          class="label deal-num"
          v-if="userInfo.dealNum > 0">
          <image
            class="label__icon"
            src="../../../static/goods-detail/deal.svg"
            mode="" />
...
export default {
  ...
  methods: {
    ...
    //渲染页面
    async renderPage(nickName = "点击登录", avatarUrl) {
      this.showLogin = false;
