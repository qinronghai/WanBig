		...
		<van-transition :show="show_a" name="fade-right" custom-class="block" :duration="entime">
			<view class="a_contain">
				<view class="a_inp shadow">
					...
					<input @confirm="confirm" @input="isbnInput" :value="isbn" type="number" maxlength="13" placeholder-class="a_pla" placeholder="请输入书本的ISBN号码" />
			...
			<view class="a_sao">
				<button class="shadow" @tap="scan">点击扫码</button>
			</view>
		</van-transition>
		<!-- 步骤二 -->
				...
				<view class="b_card">
					...
					<block v-if="chooseCollege">
						...
						<view class="b_bar">
							...
							<picker mode="multiSelector" @change="bindMultiPickerChange" @columnchange="bindMultiPickerColumnChange" :value="multiIndex" :range="newArr">
								<view class="b_picker">
...
export default {
	...
	methods: {
		...
		async subscribNews() {
			...
			const tmplIdsArray = ['W6CsnO_5tp5kxNFMjFsh9z7PwuXWe_OUyXHxsNQeTag'];
