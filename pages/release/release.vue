...
export default {
  ...
  data() {
    return {
      richText: `<h1 id="-">项目介绍</h1>
<p>本项目的前身是《湾大杂货铺》(于2021年11月份开发完成上线)，上线之后经过小规模的校园推广，注册登录用户后台显示达2500人。由于初次开发，能力有限，代码有诸多的bug且本人时间精力有限，很大程度是我想重新重构这个项目，然后《湾大杂货铺》小程序停止了维护。</p>
<p>后面我转入学习vue和uniapp，记不清具体什么时间点才重新重构《湾大杂货铺》了。好在最后也完成了。可是我又觉得是从一座代码屎山到另外一座代码屎山罢了。</p>
<p>当初我的想法是，在原来《湾大杂货铺》的基础上，把书籍部分的逻辑抽离出来做一个二手书市场。后来也不清楚，为什么这部分没做。所以这一版的书籍部分还是混在一起的。</p>
<hr>
<h2 id="2023-09-12">2023-09-12</h2>
<p>重启项目</p>
<hr>
<h2 id="2022-08-09">2022-08-09</h2>
<h3 id="-">主要功能</h3>
<p>主要功能在之前的基础上，添加了：</p>
<ol>
<li>全新的设计及重构。</li>
...
`,
      ...
      /* 显示控制-show */
      showPage: 0, // 控制真页面切换 0：fack页面， 1：商品发布页面，2：图书发布页面
  ...
  async onLoad(options) {
    ...
    await db
      ...
      .then((res) => {
        ...
        console.log("curTime < allowTime", curTime < allowTime);
