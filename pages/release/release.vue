		...
		<VanTabs :activePage="activePage" animated class="van-tabs" color="#ffc300" swipeable background="#e9e9e9">
			...
			<VanTab title="商品发布" class="good-container" color="#ffc300">
				...
				<div class="goods-wrap">
					<div class="top shadow">
						<div class="top__item price">
							...
							<div class="input">
								<uni-number-box :value="price" @change="priceChange" :min="1" :step="0.5" :max="1000">
								</uni-number-box>
							</div>
						</div>
					</div>
					...
					<div class="bottom shadow">
						<!-- 商品分类 -->
						<div class="bottom__item category" @click="showCategoryPopup">
							<div class="left">
								<image src="../../static/release/category.svg" class="icon"></image>
								<div class="txt">商品分类 (必选)</div>
							</div>
							<div class="option">
								<van-icon v-show="showCategoryArrow" name="arrow" size="36rpx" />
						...
						<van-popup duration="900" :show="showGoodsCategory" round position="bottom" custom-style="height: 40%"
							...
							<div class="goods-category">
								<div class="goods-category__item" v-for="item in navList" :key="item.id">
									<div class="goods-category__item--block" @click="handleCategoryPopup(item.id)">
										<image class="icon" :src="item.img" />
										<div class="txt" :class="{ active: item.id === clickCateIndex }">
											{{ item.txt }}
										</div>
									</div>
								</div>
						...
						<!-- 商品成色 -->
						<div @click="showConditionPopup" class="bottom__item">
							<div class="left">
								<image src="../../static/release/goods-condition.svg" class="icon"></image>
								<div class="txt">商品成色</div>
							</div>
							<div class="option">
								<van-icon v-show="showQualityArrow" name="arrow" size="36rpx" />
				...
				<div class="send-wrap shadow">
					...
					<div class="floor-num" v-if="delivery == '自提'">
						<view class="input-place">
							<input maxlength="20" placeholder="请输入您的详细地址" :value="place" @input="placeChange" />
						</view>
					</div>
				</div>
				<!-- 商品备注 和 提示 -->
				<view class="note-tips-wrap shadow">
					...
					<view class="b_notes">
						<view class="b_text">
							<textarea :value="notes" @input="noteChange" maxlength="50" placeholder="请随便说点相关的"></textarea>
				...
				<view class="submit_btn">
					<button class="btn" type="primary" @click="handleClickSubmit">
						提交审核
					</button>
				</view>
			</VanTab>
