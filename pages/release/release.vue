		...
		<VanTabs :activePage="activePage" animated class="van-tabs" color="#ffc300" swipeable background="#e9e9e9">
			...
			<VanTab title="商品发布" class="good-container" color="#ffc300">
					...
					<div class="bottom shadow">
						...
						<van-popup duration="900" :show="showGoodQuality" round position="bottom" custom-style="height: 40%" @close="onCloseGoodQuality" closeable>
							<div class="goods-condition">
								<div class="goods-condition__item" v-for="(item, index) in conditionList" :key="index" @click="handleConditionPopup(index)">
				...
				<view class="submit_btn">
					<button class="btn" type="primary" @click="handleClickSubmit">提交审核</button>
				</view>
			</VanTab>
			<!-- 图书发布 -->
			<VanTab title="图书发布">
