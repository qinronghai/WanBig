			...
			<VanTab title="商品发布" class="container" color="#ffc300">
					...
					<div class="bottom">
						...
						<van-popup duration="900" :show="showGoodQuality" round position="bottom" custom-style="height: 40%" @close="onCloseGoodQuality" closeable>
							<div class="goods-condition">
								<div class="goods-condition__item" v-for="(item, index) in conditionList" :key="index" @click="rightTap(index)">
					...
					<div class="options">
						<radio-group @change="deliveryRadioChange">
							<label class="radio-sell">
								<radio value="自提" :checked="deliveryRadio" style="transform: scale(0.7)" />自提
							</label>
							<label class="radio">
				...
				<div class="floor-num" v-if="delivery == '自提'">
					...
					<div class="input">
						...
						<div class="input__number"> <input :value="floorNum" confirm-type="done" class="place-input" type="number" placeholder="请输入楼号" @blur="handleFloorNum" />
						</div>
					</div>
				</div>
				<!-- 提交按钮 -->
