<template>
  <div>
    <WSwiperOut height="100" v-for="(item, index) in goodsInfo" :key="index" :swiperOutBtns="getBtn" @delete="delete2(item)" @operation="handleOperation(item)" buttonWidth="60">
