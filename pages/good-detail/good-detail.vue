<template>
	<view style="height: 100%">
		<view class="top_contain">
			...
			<swiper indicator-color="#e9e9e9" indicator-active-color="#ffc300" circular indicator-dots autoplay interval="3000" :duration="800">
		...
		<view class="center_contain">
			...
			<uni-section class="mb-10" title="发布信息" titleFontSize="32rpx" titleFontWeight="600" titleColor="#000" type="line"></uni-section>
		...
		<view class="tabbar">
			...
			<view class="buy_box">
				<view class="buy shadow" @tap="buy">{{ goodinfo.status == 0 ? "立即购买" : "刚刚被抢光了" }}</view>
			</view>
		</view>
		<!-- 悬浮客服功能 -->
