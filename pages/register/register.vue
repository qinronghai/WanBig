			...
			<view class="card">
				...
				<view class="user-wrap">
					...
					<view class="input-wrapper">
						<input @input="nickInput" :value="randomNickName" maxlength="30" placeholder-class="pache" placeholder="输入您的昵称" />
					</view>
				...
				<view class="contact">
					<input @input="wxInput" :value="wxnum" maxlength="30" placeholder-class="pache" placeholder="输入您的微信号" />
				</view>
				<view class="contact">
					<input type="number" @input="qqInput" :value="qqnum" maxlength="20" placeholder-class="pache" placeholder="输入您的QQ号" />
				</view>
